...
/*!
 @brief  Subclass your application class from this to send touch data for classification by FiftyThree's touch classification system.
 @discussion If you aren't using a custom UIApplication object just alter main.m to inject this class into the event processing pipeline via the 3rd argument to UIApplicationMain.
