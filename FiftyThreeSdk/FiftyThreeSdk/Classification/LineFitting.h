...
public:
    ...
    Geometric2DLine(const T &a, const T &b, const T &c)
    : _offset(c)
    {
        _orientation(0) = a;
        _orientation(1) = b;
    ...
    Geometric2DLine(const Eigen::Matrix<T, 3, 1> &coeffs)
    : _offset(coeffs(2))
    {
...
public:
    QuadraticallyParameterized2DLine()
    : _velocity0((T)0.0f)
