# This script analyzes data generated by the FiftyThreeSdkTestAppp to compute various
# statistics on the timing between touch and tip events.
# Separate statistics are computed for up and down events.
